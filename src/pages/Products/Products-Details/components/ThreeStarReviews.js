      ...
      <ListGroup flush>
        <ListGroupItem>
          <Card className="border-0 text-start shadow-none">
            ...
            <CardText>
              Got this to help during loadshedding with alarm system - 3 point
              pronk cannot easily insert - not really for an elderly person
              usage.
            </CardText>
        ...
        <ListGroupItem>
          <Card className="border-0 text-start shadow-none">
            ...
            <CardText>
              Got this to help during loadshedding with alarm system - 3 point
              pronk cannot easily insert - not really for an elderly person
              usage. Got this to help during loadshedding with alarm system - 3
              point pronk cannot easily insert - not really for an elderly
              person usage. Got this to help during loadshedding with alarm
              system - 3 point pronk cannot easily insert - not really for an
              elderly person<Link>... Read more</Link>
            </CardText>
            <div class="d-flex align-items-center">
              <CardLink
                href="#"
