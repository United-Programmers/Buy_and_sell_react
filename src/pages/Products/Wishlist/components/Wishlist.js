            ...
            <CardBody> 
                <Row className='d-flex justify-content-center align-items-center'>
                    ...
                    <Col md={7}>
                        ...
                        <p> <AiFillStar className='text-warning'/> <AiFillStar className='text-warning'/> <IoIosStarHalf className='text-warning'/> <IoIosStarOutline className='text-warning'/> 3.9 (1234) <h6 className='text-primary font-size-18'>Reviews <BiChevronDown /> </h6></p>
                        <h5 className='font-family-bold'>In stock</h5>
                    </Col>
        ...
        <Card>
            <CardBody> 
                <Row className='d-flex justify-content-center align-items-center'>
                    ...
                    <Col md={7}>
                        <h2 color='info'>Men's TS Aftersport Everyday White Tee</h2>
                        <h4 className='text-primary my-4'>Thinking out Loud</h4>
                        <h6 className='color-primary'>Be the first to Whrite a review</h6>
                        <AiFillStar className='text-warning'/>
                        <AiFillStar className='text-warning'/>
                    ...
                    <Col md={3} className=" text-end px-5">
                        ...
                        <h1 className='text-end'>R 129</h1>
                        <div className='my-4'>
                            <button className='btn btn-primary w-75'>Add to Card</button>
                        </div>
                        <div className=''>
